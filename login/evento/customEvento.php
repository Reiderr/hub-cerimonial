                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <div class = "row">
                                    <div class ="col-md-2">
                                        <div class = "form-group">
                                            ...
                                            <input name = "url" disabled type="text" id="url" class="form-control" value= <?php 
                                ...
                                <div class ="row">
                                    <div class ="col-md-12">
                                        <label>Texto 1</label>
                                        <textarea rows="5" name = "mensagem1" id = "mensagem1" class ="form-control"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class ="row">
                                    <div class ="col-md-12">
                                        <label>Texto 2</label>
                                        <textarea rows="5" name = "mensagem2" id = "mensagem2" class ="form-control"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name = "eventFacebook" class="form-control" placeholder="link do evento no facebook">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Fanpage no facebook</label>
                                                <input type="text" name = "eventFacebook" class="form-control" placeholder="link da fanpage do evento no facebook">
                                            </div>
                                        </div>
                                </div>
